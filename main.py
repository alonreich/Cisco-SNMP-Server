...
POSITIONS_PATH = 'topology_positions.json'
...
def load_config():
    defaults = {
        ...
        "logging": {"level": "INFO", "file": "logs/flask.log", "max_size_mb": 5},
    }
...
# ─────────────────────────────────────────────────────────────────────────────
# Logic (Zero Cache Mode)
# ─────────────────────────────────────────────────────────────────────────────
def get_fresh_device_data():
    """Direct database read to avoid stale caching."""
    ...
    for d in devices:
        ...
        # Interface processing for Leaderboard (Delta Calculation)
...
# ─────────────────────────────────────────────────────────────────────────────
# Zero Cache Policy: Force browser to never cache any response
# ─────────────────────────────────────────────────────────────────────────────
@app.after_request
def add_header(r):
...
def api_device_history(ip):
    """Return time-series data for a device. metric=cpu|memory, hours=1|6|24|168."""
...
def api_alerts():
    """Return alerts, optionally filtered by ip."""
